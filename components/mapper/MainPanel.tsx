...
import { Plus, FileText, Upload, Maximize, Minimize } from 'lucide-react';
...
export const MainPanel: React.FC = () => {
  ...
  return (
    <main className="flex-1 bg-zinc-950 h-screen flex flex-col overflow-hidden relative">
      ...
      <header className="h-16 border-b border-zinc-800 flex items-center justify-between px-6 gap-6 shrink-0 bg-zinc-950/80 backdrop-blur-md z-20">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="p-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-zinc-200 transition-colors border border-zinc-700 hover:border-zinc-600"
      ...
      {/* Workspace Area - Visible Dotted Mesh */}
      <div className="flex-1 overflow-auto bg-zinc-950 bg-[radial-gradient(#3f3f46_1px,transparent_1px)] [background-size:20px_20px] flex justify-center p-8">
