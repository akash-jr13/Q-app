...
export const HistoryInterface: React.FC<HistoryInterfaceProps> = ({ onExit, onAnalyze }) => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 font-sans text-sm text-zinc-300 selection:bg-zinc-800 selection:text-zinc-100 relative">
      ...
      <div className="w-full max-w-[98%] mx-auto p-4 md:p-6 relative z-10 min-h-[calc(100vh-120px)] flex flex-col">
        {isLoading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-zinc-500 gap-4 border border-dashed border-zinc-800 rounded-2xl bg-zinc-900/20 my-8">
